	...
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
    	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 news_box first_news_box">
        	<div>
        		<div  class="row" >
        		<div class="col-12">
        			<h3 class="margin_bottom_10 font_size_26 color_000 font_weight_700 text-uppercase">Todas las Ventas por Internet Canceladas</h3>
        		</div>
					        ...
					        <?php 
					        	...
					        	foreach ($ventas as  $p)
					        	{
					        		if(1==1)
					        		{
					        			...
					        			$estado = '<span style="color:black;font-size: 16px;">'.$p["estado"].'</span>';
					        			$btn = '';
					        			$stl_row='';
