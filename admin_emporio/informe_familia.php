...
$vpc = negInforme::ventasPorFamilia($fini,$ffin);
...
<div class="row" style="margin-top: -40px;">
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
    	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 news_box first_news_box">
        	<div>
              ...
              <?php 
        			...
        			foreach ($cajas as $c)
        			{
        				...
        				$goCaja =util::creaURLApp(0, "informe_familia","&cajaid=".$cajaidIn);
        				...
        				foreach ($uCajas as $uc)
        				{
        					if($cajaidIn == $uc["cajaid"])
        					{
        						...
        						echo '<option '.$sel.' value="'.$goCaja.'">'.$c["tipo"].'</option>';		
        	...
        	<div class="col-8">   
        	<form id="info" name="info" action="<?php echo util::creaURLApp(0, "informe_familia","&cajaid=".$cajaid);?>" method="post">
              ...
              <div  class="row" >
	              <div class="col-sm-12"> 
	                <table id="tabla-lista" class="cell-border" style="width:100%">
					        <thead>
					            <tr>
					                <th style="border: 1px solid #949393; background-color: #f7f7f7; " >Tipo Producto</th>
