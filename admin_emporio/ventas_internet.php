	...
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
    	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 news_box first_news_box">
        	<div>
        		<div  class="row" >
        		<div class="col-12">
        			<h3 class="margin_bottom_10 font_size_26 color_000 font_weight_700 text-uppercase">Ventas por Internet Pendientes</h3>
        		</div>
        		
            	
        		<div class="col-12 margin_bottom_10">
        		<a style="margin-bottom: 10px;"  href="<?php echo util::creaURLApp(0, "ventas_canceladas");?>" class="btn_about_us oswald_font">Ventas Canceladas</a>
	              ...
	              <div class="col-sm-12"> 
	                <table id="tabla-lista" class="cell-border" style="width:100%">
					        ...
					        <?php 
					        	...
					        	foreach ($ventas as  $p)
					        	{
					        		if($p["estado"] != 'CANCELADA' && $p["estado"] != 'ENTREGADA' )
					        		{
					        			$cont ++;
					        			$ventaid = $p["ventaid"];
					        			...
					        			if($p["estado"] == 'PENDIENTE')
					        			{
					        				...
					        				$btn = '<button style="padding: 0px;padding-top: 3px;padding-bottom: 3px;width: 120px;font-size: 12px;background-color: #47a00c;margin:1px;" type="button" class="btn btn-primary"
															...
															data-toggle="modal" data-target="#modal_despacha" data-backdrop="static" data-keyboard="false">Despachar Venta</button>
											  ...
											  <button style="padding: 0px;padding-top: 3px;padding-bottom: 3px;width: 120px;font-size: 12px;background-color: #e21919;border-color: #f00;margin:1px;"
																...
																onclick="javascript:cancelaVentaOpen('.$ventaid.');">Cancelar Venta</button>';
					        			}
					        			if($p["estado"] == 'DESPACHADA')
					        			{
					        				$stl_row='style="background:#f7f7f7;"';
					        			}
