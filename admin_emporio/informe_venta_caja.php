...
$vpc = negInforme::informe_ventasPorDiaPorCaja($cajaid,$fini,$ffin);
      ...
      function drawChartVentaBarra() {
        ...
        var options = {
          chart: {
            ...
            subtitle: 'Los días que no se muestran es porque no hubo venta',
          }
        };
	...
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
    	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 news_box first_news_box">
        	<div>
        		<div  class="row" >
        		<div class="col-12">
        			<h3 class="margin_bottom_10 font_size_26 color_000 font_weight_700 text-uppercase">Informe de Ventas</h3>
        		</div>
        	...
        	<div class="col-8">   
        	<form id="info" name="info" action="<?php echo util::creaURLApp(0, "informe_caja","&cajaid=".$cajaid);?>" method="post">
              ...
              <div  class="row" >
	              <div class="col-sm-12"> 
	                <table id="tabla-lista" class="cell-border" style="width:100%">
					        <thead>
					            <tr>
					                <th style="border: 1px solid #949393; background-color: #f7f7f7; " >Día</th>
					                <th style="border: 1px solid #949393; background-color: #f7f7f7;border-left: 1px solid #fff;">Cantidad de Productos</th>
					        ...
					        foreach ($vpc as $v)
					        {
					        			...
					        			echo '
											<tr>
								                <td style="text-align:left;color:black;"><strong>'.$v["dia"].' </strong> </td>
												...
												<td style="text-align:center; color:black;"><a style="font-size: 13px;" href="'.util::creaURLApp(0, "informe_detalle_venta","&cajaid=".$cajaid."&param=".$v["dia"]."&tipo=dia").'"  type="button" class="btn btn-primary" >Ver Detalle</a> </td>
